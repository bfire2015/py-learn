...
class BossSpider(scrapy.Spider):
	...
	headers = {
		...
		'Host':'www.zhipin.com',
		'Referer':'https://www.zhipin.com/job_detail/?query=php&scity=101280600&industry=&position=',
	}

	def start_requests(self):
		urls = [
			#'https://www.zhipin.com/job_detail/?query=ai&scity=101280600&industry=&position=',
			'https://www.zhipin.com/c101280600/h_101280600/?query=php&ka=recommend-job-list'
		]
		for url in urls:
