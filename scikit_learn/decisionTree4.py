...
# -*- coding: utf-8 -*-
"""
__title__ = '33、分类树、回归树的区别与实战代码案例：波士顿房租价格预测_笔记'
__author__ = 'BfireLai'
__mtime__ = '2018/5/21'
"""
...
print('普通最小二乘法线性回归r-score', lr_score)
...
plt.plot(ln_x_test, y_test_hat, 'g-', lw=4, label=u'回归决策树，$R^2$=%.3f' % score)
plt.xlabel(u'数据编码', fontsize=16)
plt.ylabel(u'房屋租赁价格', fontsize=16)
plt.legend(loc = 'upper center')
plt.grid(True)
plt.title(u'波士顿房屋租赁价格预测', fontsize=18)
plt.show()
